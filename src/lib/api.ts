...
export const fallbackData = {
  settings: {
    ...
    home_about_text: 'At Brokline Foundation, we believe that when you empower a girl, you lift an entire community. We provide under-resourced adolescent girls and young women with the resources, education, mentorship, and economic tools required to break the cycle of poverty and lead self-determined lives.',
  ...
  stories: [
    {
      ...
      quote: 'Brokline gave me a computer, taught me how to write code, and showed me that my background does not define my future.',
  ...
  events: [
    {
      ...
      location: 'Brokline Community Hall, Boston, MA',
